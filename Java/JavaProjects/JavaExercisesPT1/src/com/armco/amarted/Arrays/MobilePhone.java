...
public class MobilePhone {
    ...
    private int findContact(String contactName){
        // loop through all records and return index position if on file
    ...
    public String queryContact(Contact contact){
        // to return the data from another method; is public so other classes can access it
